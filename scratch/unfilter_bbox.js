...
function unfilterPng(buf) {
    ...
    return { w, h, minX, maxX, minY, maxY, width: maxX - minX + 1, height: maxY - minY + 1 };
}

console.log('PNG real bbox:', unfilterPng(fs.readFileSync('scratch/png_extracted.png')));
console.log('ICE real bbox:', unfilterPng(fs.readFileSync('scratch/ice_extracted.png')));
